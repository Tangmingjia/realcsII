...
//    var oidField : UITextField?
    ...
    var BluetoothReloadBtn : UIButton?
    
    var BluetoothDoneBtn : UIButton?
...
//        self.addSubview(pickerView!)
        ...
        self.BluetoothView = UIView()
        self.addSubview(BluetoothView!)
        
        self.BluetoothTableView = UITableView()
        self.BluetoothView?.addSubview(BluetoothTableView!)
        
        self.BluetoothReloadBtn = UIButton()
        self.BluetoothView?.addSubview(BluetoothReloadBtn!)
        
        self.BluetoothDoneBtn = UIButton()
        self.BluetoothView?.addSubview(BluetoothDoneBtn!)
...
//        self.ScanButton?.layer.masksToBounds = true
        ...
        self.bluetoothButton?.frame = CGRect(x: ScreenSize.width-100, y: 20, width: 80, height: 20)
        self.bluetoothButton?.setTitle("蓝牙连接", for: .normal)
        self.bluetoothButton?.setTitleColor(UIColor.white, for: .normal)
        self.bluetoothButton?.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        ...
        self.BluetoothView?.frame = CGRect(x: 100, y: 20, width: ScreenSize.width-200, height: ScreenSize.height-40)
        self.BluetoothView?.backgroundColor = UIColor.white
        self.BluetoothView?.isHidden = true
        
        self.BluetoothTableView?.frame = CGRect(x: 0, y: 0, width: ScreenSize.width-200, height: ScreenSize.height-80)
        self.BluetoothTableView?.backgroundColor = UIColor.clear
        self.BluetoothTableView?.separatorInset = UIEdgeInsets.zero   //分割线左边顶格
        
        self.BluetoothReloadBtn?.frame = CGRect(x: 0, y: ScreenSize.height-80, width: (ScreenSize.width-200)/2, height: 40)
        self.BluetoothReloadBtn?.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        self.BluetoothReloadBtn?.setTitle("刷新", for: .normal)
        self.BluetoothReloadBtn?.setTitleColor(UIColor.black, for: .normal)
        
        self.BluetoothDoneBtn?.frame = CGRect(x: (ScreenSize.width-200)/2, y: ScreenSize.height-80, width: (ScreenSize.width-200)/2, height: 40)
        self.BluetoothDoneBtn?.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        self.BluetoothDoneBtn?.setTitle("确定", for: .normal)
        self.BluetoothDoneBtn?.setTitleColor(UIColor.black, for: .normal)
    }
